...
DWORD WINAPI Main(LPVOID)
{
    ...
    WriteProcessMemory(GetCurrentProcess(), (LPVOID)(Base + 0x3838C78), "\xC7\x03\x00\x00\x00\x00", 6, NULL); // failed to decrypt toc
    ...
    WriteProcessMemory(GetCurrentProcess(), (LPVOID)(Base + 0x3838C78), "\xC7\x03\x0C\x00\x00\x00", 6, NULL); // failed to decrypt toc
