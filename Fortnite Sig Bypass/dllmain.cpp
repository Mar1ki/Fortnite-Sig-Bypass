...
DWORD WINAPI Main(LPVOID)
{
    ...
    WriteProcessMemory(GetCurrentProcess(), (LPVOID)(Base + 0x383048A), "\x41\xC7\x04\x24\x00\x00\x00\x00", 8, NULL); // failed to decrypt toc
    ...
    WriteProcessMemory(GetCurrentProcess(), (LPVOID)(Base + 0x383048A), "\x41\xC7\x04\x24\x0C\x00\x00\x00", 8, NULL); // failed to decrypt toc
